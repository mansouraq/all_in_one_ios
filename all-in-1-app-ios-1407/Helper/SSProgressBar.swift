...
open class SSProgressBar: UIView {
    ...
    @IBInspectable public var cornerRadiusBar: CGFloat = 0.0 {
        didSet {
            self.updateView(params: .cornerRadius)
        }
    }
    
    @IBInspectable public  var borderWidthBar: CGFloat = 0 {
        didSet {
    ...
    @IBInspectable public var shadowColorBar: UIColor? = UIColor.clear {
        didSet {
            self.updateView(params: .shadowColor)
        }
    }
    
    @IBInspectable public var shadowOffsetBar: CGSize = CGSize(width: 0, height: 0) {
        didSet {
            self.updateView(params: .shadowOffset)
        }
    }
    
    @IBInspectable public var shadowOpacityBar: Double = 0 {
        didSet {
